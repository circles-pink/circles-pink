...
spago-build: spago-clean spago-clean-output
	spago build --purs-args "--stash --censor-lib --censor-codes=WildcardInferredType --output {{PURS_OUTPUT}}"

spago-build-ide: spago-clean spago-clean-output
	spago build --purs-args "--stash --censor-lib --json-errors --censor-codes=WildcardInferredType --output {{PURS_OUTPUT}}"
...
ts-build:
	...
	cd pkgs/ts/storybook; tsc --build tsconfig.json
