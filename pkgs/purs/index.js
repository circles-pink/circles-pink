      ...
      return function (env) {
          return function (m) {
              return function (s) {
                  ...
                  throw new Error("Failed pattern match at Core.State.Onboard (line 72, column 19 - line 107, column 18): " + [ s.constructor.name ]);
              };
          };
      };
  };
...
(function($PS) {
  ...
  var Foreign_Object = $PS["Foreign.Object"];                
  var env = {
      apiCheckUserName: function (u) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("checking " + u))(function () {
              return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
                  ...
                  content: Data_Maybe.Just.create(Affjax_RequestBody.Json.create(Data_Argonaut_Core.fromObject(Foreign_Object.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("username", Data_Argonaut_Core.fromString(u)) ])))),
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)((function () {
                      if (r instanceof Data_Either.Left) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("ERROR"))(function () {
                              return Effect_Class_Console.log(Effect_Aff.monadEffectAff)(Affjax.printError(r.value0));
                          });
                      };
                      if (r instanceof Data_Either.Right) {
                          return Effect_Class_Console.log(Effect_Aff.monadEffectAff)(Data_Argonaut_Core.stringifyWithIndent(2)(r.value0.body));
                      };
                      throw new Error("Failed pattern match at Main (line 33, column 9 - line 37, column 61): " + [ r.constructor.name ]);
                  })())(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("API CALL: " + u))(function () {
                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(u === "foobar");
                      });
                  });
              });
          });
  ...
  var mainAff = Control_Bind.bind(Effect_Aff.bindAff)(Control_Bind.bind(Effect_Aff.bindAff)(reducerAff(Core_State_Onboard.Next.value)(Core_State_Onboard.init))(reducerAff(new Core_State_Onboard.SetUsername("nico"))))(reducerAff(Core_State_Onboard.Next.value));
  var main = Effect_Aff.runAff_(Data_Function["const"](Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit)))(mainAff);
  exports["env"] = env;
  exports["reducerAff"] = reducerAff;
