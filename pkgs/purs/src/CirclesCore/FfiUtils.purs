...
mapFn3 ::
  ...
  Fn3 l1 l2 l3 (Promise l) -> MapArg h1 e l1 -> MapArg h2 e l2 -> MapArg h3 e l3 -> MapErr e -> MapOk l e h -> h1 -> h2 -> h3 -> ExceptV e Aff h
...
mapFn2 ::
  ...
  Fn2 l1 l2 (Promise l) -> MapArg h1 e l1 -> MapArg h2 e l2 -> MapErr e -> MapOk l e h -> h1 -> h2 -> ExceptV e Aff h
...
mapFn1 ::
  forall h1 l1 h l e.
  Fn1 l1 (Promise l) -> MapArg h1 e l1 -> MapErr e -> MapOk l e h -> h1 -> ExceptV e Aff h
