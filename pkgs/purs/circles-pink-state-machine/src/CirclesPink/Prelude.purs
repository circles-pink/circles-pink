...
import PursTsGen (class ToPursType, class GenRecord, class GenToTsDefProd, class GenToTsDefSum, class GenVariant, class ToTsDef, class ToTsType, MyThese(..), PursType(..), classDef, cleanModule, constructor, defPredicateFn, defaultToPursType, defaultToTsDef, defaultToTsType, defineModules, genRecord, genToTsDefProd, genToTsDefSum, genToTsDefSum', genVariant, genericToTsDef, instanceDef, pursModule, toTsDef, toTsType, typeAlias, typeDef, value) as Exp