...
export const ButtonPinkFullWidth = tw.button`bg-white hover:bg-pink-100 border border-pink-300 border-solid text-black font-bold py-2 px-4 rounded-full mx-1 cursor-pointer w-full`;
